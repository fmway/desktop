...
> - **Display Manager** : [ly (1.3.2)](https://github.com/fairyglade/ly) <!--{< rr re.ver2 cfg.services.displayManager.ly.package.version >}-->
...
> - **Kernel** : 6.19.11 (linux) <!--{< rm [ (rver kernel.version) (rbet "(" ")" kernel.name) ] >}-->
